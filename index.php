...
?>
<img src="assets/file/kodok.jpg" style="width: 100%;">
<section class="container my-5">
	<div class="text-center">
		<h3 class="mb-5 fw-bold" data-aos="fade-right">BERITA PUSDIKZI</h3>
	</div>
	<div class="row">
...
<section class="mb-5 p-5 bg-light shadow">
	<div class="container">
		<h3 class="mb-5 text-center fw-bold" data-aos="fade-right">GALLERI PUSDIKZI</h3>
		<div class="row">
			...
			<?php endforeach ?>
			<div class="text-center mt-3">
				<a href="semua_galeri.php" class=" btn fw-bold text-white" style="background-color: #008080;">SEMUA GALLERI</a>
			</div>
		</div>
	</div>
</section>
...
<section class="mb-5 p-5">
	<div class="container">
		<h3 class="mb-5 text-center fw-bold" data-aos="fade-right">KEGIATAN PUSDIKZI</h3>
		<div class="row">
			...
			<?php endforeach ?>
			<div class="text-center mt-3">
				<a href="semua_kegiatan.php" class="btn fw-bold text-white" style="background-color: #008080;">SEMUA KEGIATAN</a>
			</div>
		</div>
	</div>
</section>
